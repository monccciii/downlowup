...
export default function Allproperties() {
  ...
  return (
    ...
    <div style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <h1 className='text-center mx-auto w-[60vw] text-2xl mb-5 font-extralight mb-[10vh]'>Interested? <span className='text-indigo underline' onClick={() => router.push('/#contact')}>Contact us!</span></h1>
